...
export default class MyCakeSlice {
    ...
    buildSlice() {
        ...
        cakeSideMeshLeft.position.set(0, 0, 0.9); 
        cakeSideMeshLeft.rotation.y = Math.PI / 2; 
        ...
        cakeSideMeshRight.position.set(0.46, 0, 0.79); 
        cakeSideMeshRight.rotation.y = 2 * Math.PI / 3;  
