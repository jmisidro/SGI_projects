...
class MyApp  {
    ...
    initCameras() {
        ...
        const perspective1 = new THREE.PerspectiveCamera( 100, aspect, 0.1, 1000 )
        perspective1.position.set(15,15,5)
        this.cameras['Perspective'] = perspective1

        // Create another perspective camera
        const perspective2 = new THREE.PerspectiveCamera( 50, aspect, 0.1, 1000 )
        perspective2.position.set(-10,8,10)
        ...
        // create a righ view orthographic camera
